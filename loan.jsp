...
<p>&nbsp;</p>	</td>
	...
	<div class="box1">
	<h2><font color="#FF0000">Banking System</font></h2>
	</div>
	<br/><p align="left" style="line-height:18px; padding:10px; font-weight:normal">The bank provides a Loan to all its members.But to get a loan the person has to come to the bank and submit various documents as a Proof for the Loan.</p>
	</td>
  </tr>
